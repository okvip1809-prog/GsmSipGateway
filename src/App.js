...
export default function App() {
  ...
  return (
    ...
    >
      ...
      <Field label="FreePBX IP" value={host} onChangeText={setHost} keyboardType="numbers-and-punctuation" />
      <Field label="SIP Port" value={port} onChangeText={setPort} keyboardType="numeric" />
      <Field label="SIP Username" value={username} onChangeText={setUsername} />
      <Field label="SIP Password" value={password} onChangeText={setPassword} secure />
      <Field label="Bridge Target (extension or SIP URI)" value={bridgeExtension} onChangeText={setBridgeExtension} />
      <Field label="Answer After Rings" value={answerRings} onChangeText={setAnswerRings} keyboardType="numeric" />
