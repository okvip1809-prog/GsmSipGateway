...
export default function App() {
  ...
  const reloadGateway = async () => {
    try {
      const result = await SipBridge.reloadService();
      setStatus('Reloading service...');
      Alert.alert('Reload', result);
    } catch (e) {
      Alert.alert('Error', e.message);
    }
  };
  ...
  return (
    ...
    >
      ...
      <TouchableOpacity style={styles.btnReload} onPress={reloadGateway}>
        <Text style={styles.btnText}>Reload Services</Text>
      </TouchableOpacity>
